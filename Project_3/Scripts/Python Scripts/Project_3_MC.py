...
plt.savefig(savepath+"MC_Integral_BF.png")
...
plt.savefig(savepath+"MC_Integral_IS.png")
#plt.xlim(10000, 1000000000)
...
plt.savefig(savepath+"MC_Relative_Error.png")
#plt.xlim(10000, 1000000000)
#plt.ylim(-0.2, 2.55)
plt.tight_layout()
...
plt.savefig(savepath+"MC_CPU_Time.png")
plt.tight_layout()
