...
plt.savefig(path+"GQ_Integral_Even_Odd.png")
plt.tight_layout()
...
plt.ylabel('Estimated solution of integral', fontsize=14)
plt.title("Convergency of Legendre $\&$ Laguerre", fontsize=15)
plt.savefig(path+"GQ_Integral.png")
plt.tight_layout()
...
plt.savefig(path+"GQ_Relative_Error.png")
plt.tight_layout()
...
plt.savefig(path+"CPU_Time_GQ.png")
plt.tight_layout()
...
plt.ylabel('Relative error $\epsilon$', fontsize=14)
plt.title("Relative error [Legendre $\&$ Laguerre]", fontsize=15)
plt.savefig(path+"GQ_Relative_Error_Even_Odd.png")
plt.tight_layout()
plt.show()
