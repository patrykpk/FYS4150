...
plt.plot(N_even, leg_even, linewidth=0.5,
         marker="o", color="r", markersize=2, label='GQ-Legendre Even')
plt.plot(N_odd, leg_odd, linewidth=0.5, marker="o",
         markersize=2, c='C0', label='GQ-Legendre Odd')
plt.plot(N, lag, linewidth=0.5, color="orange", linestyle="-", label='GQ-Laguerre')
...
plt.savefig(savepath+"GQ_Integral_Even_Odd.png")
plt.tight_layout()

plt.figure(2)
plt.plot(N, leg, linewidth=0.5, linestyle="-", markersize=2, label='GQ-Legendre')
plt.plot(N, lag, linewidth=0.5, linestyle="-", label='GQ-Laguerre')
plt.plot(N, exact, linewidth=0.5, color="green", linestyle="--", label='Exact solution')
plt.legend(loc='upper right', prop={"size": 12})
plt.xlabel("Number of iterations [N]", fontsize=14)
plt.ylabel('Estimated solution of integral', fontsize=14)
plt.title("Convergency of Legendre $\&$ Laguerre", fontsize=15)
plt.savefig(savepath+"GQ_Integral.png")
plt.tight_layout()
...
plt.savefig(savepath+"GQ_Relative_Error.png")
plt.tight_layout()
...
plt.savefig(savepath+"CPU_Time_GQ.png")
plt.tight_layout()
...
plt.ylabel('Relative error $\epsilon$', fontsize=14)
plt.title("Relative error [Legendre $\&$ Laguerre]", fontsize=15)
plt.savefig(savepath+"GQ_Relative_Error_Even_Odd.png")
plt.tight_layout()
plt.show()
