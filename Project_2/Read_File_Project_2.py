...
def Read_file(filename):
    ...
    elif filename.startswith("qdot1"):
        path = "./Results/Qdot1/"
    elif filename.startswith("qdot2"):
        path = "./Results/Qdot2/"
...
Buckling = [filename for filename in os.listdir("./Results/Buckling_beam") if filename.startswith("buckling_") and filename.endswith(".txt")] 
Qdot1 = [filename for filename in os.listdir("./Results/Qdot1") if filename.startswith("qdot1") and filename.endswith(".txt")]
Qdot2 = [filename for filename in os.listdir("./Results/Qdot2") if filename.startswith("qdot2") and filename.endswith(".txt")]
...
plt.savefig("./Figures/CPU_Time_Buckling.png")
...
plt.xlim(n_Buckling[0],n_Buckling[-1])
plt.ylim(0,180)
plt.savefig("./Figures/Iterations_Buckling.png")
...
plt.savefig("./Figures/Absolute_Error_Qdot1.png")
...
plt.xlim(400,450)
plt.ylim(0,2)
plt.savefig("./Figures/Absolute_Error_Eigval3_Qdot1.png")
...
plt.savefig("./Figures/Groundstate_Eigval_Qdot2.png")
