...
graph_data = open(
    '/Users/kristoffervarslott/Documents/C++/FYS4150/Project4/Project_4_General/Temperature.txt', 'r').read()
...
# plt.tight_layout()
#plt.plot([0, 5000], [-1.99598208594, -1.99598208594], linestyle='--', color="k")
